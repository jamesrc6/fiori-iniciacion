		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Invoices List",
									"targetURL": "#axelerapeinvoices-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"axelerapeinvoices-display": {
								"semanticObject": "axelerapeinvoices",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=axelera.pe.invoices",
									"url": sap.ui.require.toUrl("axelera/pe/invoices")
								}
							}
						}
					}
